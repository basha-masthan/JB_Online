...
export const courses = [
  { id: "eee", name: "Electrical & Electronics Engineering", icon: Zap, short: "EEE" },
  { id: "chemical", name: "Chemical Engineering", icon: FlaskConical, short: "Chemical" },
  { id: "cse", name: "Computer Science Engineering", icon: Code2, short: "CSE" },
  { id: "ece", name: "Electronics & Communication", icon: Radio, short: "ECE" },
  { id: "programming", name: "C & Python (Open for Everyone)", icon: Terminal, short: "C & Python" },
  { id: "mechanical", name: "Mechanical Engineering", icon: Cog, short: "Mechanical" },
  { id: "civil", name: "Civil Engineering", icon: Building2, short: "Civil" },
  { id: "metallurgy", name: "Metallurgical & Material Science", icon: Hammer, short: "Metallurgy" },
];
          ...
          {courses.map((c) => (
            ...
            >
              ...
              <Button asChild variant="ghost" size="sm" className="mt-2 px-0 text-primary font-semibold hover:bg-transparent hover:text-primary/80">
                <Link to={`/course/${c.id}`} className="flex items-center">
